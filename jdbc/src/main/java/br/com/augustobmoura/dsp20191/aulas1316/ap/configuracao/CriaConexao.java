...
import br.com.augustobmoura.dsp20191.aulas1316.ap.exceptions.InvalidDataBaseTypeException;

import java.sql.Connection;
import java.sql.DriverManager;
import java.sql.SQLException;

public class CriaConexao implements FabricaConexao {

  public static final String DEFAULT_CONNECTION_TYPE = "file";
  ...
  public Connection construirConexao() {
    return getConnection(DEFAULT_CONNECTION_TYPE);
  }
